...
pnr_url = "http://indianrail.gov.in/pnr_Enq.html"
driver = get_driver(pnr_url)
#pnr_no = '4140576839'
get_pnrstatus(driver, pnr_no)

imp_stations_url = "http://indianrail.gov.in/between_Imp_Stations.html"
driver = get_driver(imp_stations_url) 
...
train_number = '18463'
get_availablity(driver, train_number)
